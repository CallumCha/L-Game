		...
		if (Board[a][b] != "C" && Board[a][b] != "B" && Board[a][b] != "R") {
			...
			if (CheckForMoves(colour) == 0) {
				...
				if (colour == "R") {
					...
					document.write("<center><h1>Blue wins the game</h1><button><a href='GameScr.html'>Play again?</Button> <Button><a href='index.html'>Home</Button></center>")
